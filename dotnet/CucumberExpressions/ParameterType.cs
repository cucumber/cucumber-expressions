...
//    private static readonly Regex ILLEGAL_PARAMETER_NAME_PATTERN = new("([{}()\\\\/])");
//    private static readonly Regex UNESCAPE_PATTERN = new("(\\\\([\\[$.|?*+\\]]))");

//    private readonly String name;
//    private readonly Type type;
//    private readonly List<String> regexps;
//    private readonly bool preferForRegexpMatch;
//    private readonly bool useForSnippets;
//    private readonly CaptureGroupTransformer<T> transformer;
//    private readonly bool anonymous;
//    private readonly bool useRegexpMatchAsStrongTypeHint;
...
//            bool useForSnippets, bool preferForRegexpMatch, bool useRegexpMatchAsStrongTypeHint,
//            bool anonymous) {
//        if (regexps == null)
...
//    public ParameterType(String name, List<String> regexps, Type type, CaptureGroupTransformer<T> transformer,
//            bool useForSnippets, bool preferForRegexpMatch) {
...
//    public ParameterType(String name, String regexp, Class<T> type, Transformer<T> transformer, bool useForSnippets,
//            bool preferForRegexpMatch, bool useRegexpMatchAsStrongTypeHint) {
//        this(name, singletonList(regexp), type, transformer, useForSnippets, preferForRegexpMatch,
//                useRegexpMatchAsStrongTypeHint);
//    }
...
//     */
//    public bool preferForRegexpMatch() {
...
//     * expression match
//     */
//    public bool useRegexpMatchAsStrongTypeHint() {
