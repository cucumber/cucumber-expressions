defmodule Varar.CucumberExpressions.CombinatorialGeneratedExpressionFactory do
  @moduledoc false

  alias Varar.CucumberExpressions.GeneratedExpression
  ...
  """
  def generate_expressions(template, parameter_type_combinations) do
    ...
    |> Enum.map(&GeneratedExpression.new(template, &1))
  end
end
