defmodule Varar.CucumberExpressions.RegularExpression do
  @moduledoc """
  ...
  @doc """
  Matches `text`. Returns a list of `Varar.CucumberExpressions.Argument`s or
  `nil` if the text does not match. Raises
  `Varar.CucumberExpressions.AmbiguousParameterTypeError` if a capture group's
