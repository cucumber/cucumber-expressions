defmodule Varar.CucumberExpressions.GroupBuilder do
  @moduledoc """
  The compile-time shape of a regexp's capture groups, built by
  `Varar.CucumberExpressions.TreeRegexp`. At match time, `build/3` pairs the
  shape with the flat list of match indices to produce a
  `Varar.CucumberExpressions.Group` tree.
  """

  alias Varar.CucumberExpressions.Group
