defmodule Varar.CucumberExpressions.TreeRegexp do
  @moduledoc """
  A regexp paired with the tree structure of its capture groups, so a match
  can be presented as a `Varar.CucumberExpressions.Group` tree instead of a
  flat list.
  ...
  `Varar.CucumberExpressions.Error`.
  """

  alias Varar.CucumberExpressions.{Error, Group, GroupBuilder}
  ...
  `Varar.CucumberExpressions.Error` for named capture groups.
  """
