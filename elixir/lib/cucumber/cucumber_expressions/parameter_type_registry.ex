defmodule Cucumber.CucumberExpressions.ParameterTypeRegistry do
  @moduledoc """
  An immutable registry of `Cucumber.CucumberExpressions.ParameterType`s.
  ...
  `Cucumber.CucumberExpressions.AmbiguousParameterTypeError` when several types
