defmodule Varar.CucumberExpressions.ExpressionFactoryTest do
  use ExUnit.Case, async: true

  alias Varar.CucumberExpressions, as: CE
  alias Varar.CucumberExpressions.{CucumberExpression, ParameterTypeRegistry, RegularExpression}
