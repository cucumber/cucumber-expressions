defmodule Varar.CucumberExpressions.ErrorTest do
  use ExUnit.Case, async: true

  alias Varar.CucumberExpressions.{Error, ParameterType, ParameterTypeRegistry}
  alias Varar.CucumberExpressions.CucumberExpression, as: CE
